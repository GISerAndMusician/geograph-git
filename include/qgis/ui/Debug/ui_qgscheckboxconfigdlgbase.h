...
public:
    ...
    {
        groupBox_2->setTitle(QApplication::translate("QgsCheckBoxConfigDlgBase", "Display Settings", nullptr));
        label_5->setText(QApplication::translate("QgsCheckBoxConfigDlgBase", "Display the checkbox state as a plain text value (e.g. in an attribute table) using", nullptr));
        groupBox->setTitle(QApplication::translate("QgsCheckBoxConfigDlgBase", "Representation", nullptr));
        label_3->setText(QApplication::translate("QgsCheckBoxConfigDlgBase", "Unchecked state", nullptr));
        label_2->setText(QApplication::translate("QgsCheckBoxConfigDlgBase", "Checked state", nullptr));
        label_4->setText(QApplication::translate("QgsCheckBoxConfigDlgBase", "The checked and unchecked representation state are the raw values stored in the layer when the checkbox is checked or unchecked.", nullptr));
