...
public:
    ...
    void setupUi(QMainWindow *QgsCustomizationDialogBase)
    {
        ...
        QgsCustomizationDialogBase->resize(515, 370);
    ...
    void retranslateUi(QMainWindow *QgsCustomizationDialogBase)
    {
        ...
        mLeFilter->setProperty("placeholderText", QVariant(QApplication::translate("QgsCustomizationDialogBase", "Search\342\200\246", nullptr)));
