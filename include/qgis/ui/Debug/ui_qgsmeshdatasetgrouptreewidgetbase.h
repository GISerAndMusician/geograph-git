...
public:
    ...
    void setupUi(QWidget *QgsMeshDatasetGroupTreeWidgetBase)
    {
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/themes/default/mActionExpandTree.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/images/themes/default/mActionSelectAllTree.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/images/themes/default/mActionDeselectAllTree.svg"), QSize(), QIcon::Normal, QIcon::Off);
