...
public:
    ...
    void retranslateUi(QDialog *QgsNewHttpConnectionBase)
    {
        ...
        cbxIgnoreGetMapURI->setText(QApplication::translate("QgsNewHttpConnectionBase", "Ignore GetMap/GetTile/GetLegendGraphic URI reported in capabilities", nullptr));
