...
public:
    ...
    void setupUi(QWidget *QgsListConfigDlg)
    {
        ...
        QgsListConfigDlg->resize(400, 80);
    ...
    {
        mNullBehavior->setTitle(QApplication::translate("QgsListConfigDlg", "Treatment of Empty Cells", nullptr));
        mEmptyisNull->setText(QApplication::translate("QgsListConfigDlg", "NULL", nullptr));
        mEmptyisEmptyArray->setText(QApplication::translate("QgsListConfigDlg", "Empty Array", nullptr));
        Q_UNUSED(QgsListConfigDlg);
    } // retranslateUi
