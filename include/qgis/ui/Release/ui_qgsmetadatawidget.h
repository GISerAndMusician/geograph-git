...
public:
    ...
    void setupUi(QWidget *QgsMetadataWidgetBase)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 777, 653));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 398, 482));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 250, 342));
