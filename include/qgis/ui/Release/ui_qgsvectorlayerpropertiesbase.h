...
public:
    ...
    void setupUi(QDialog *QgsVectorLayerPropertiesBase)
    {
        ...
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/images/themes/default/propertyicons/overlay.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 360, 520));
        ...
        txtDisplayName->setStyleSheet(QString::fromUtf8("color: #505050;\n"
...
"border-radius: 2px;"));
        ...
        scrollAreaWidgetContents_7->setGeometry(QRect(0, 0, 146, 124));
        ...
        scrollAreaWidgetContents_19->setGeometry(QRect(0, 0, 804, 305));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 387, 741));
