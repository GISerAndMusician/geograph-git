#ifndef COMPUTE_GEOMETRY_H
#define COMPUTE_GEOMETRY_H
...
namespace GeneralGeometry {
	...
	// 2.7、求直线P1P2与X轴夹角
	double angleOfLineAndX(const Point& p1, const Point& p2, bool is_radian = true);
	...
	double angleOfLineAndX(const Point& p1, const Point& p2, bool is_radian)
	{
		double x = p2.x - p1.x;
		double y = p2.y - p1.y;
