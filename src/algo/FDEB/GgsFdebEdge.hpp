...
struct GgsFdebEdge
{
     ...
     */
    GgsFdebEdge(std::string sourceLabel_, std::string targetLabel_,
         meerkat::mk_vector2 &start_, meerkat::mk_vector2 &end_,
         double width_);

	std::vector<meerkat::mk_vector2> points();
     ...
     */
    static double angle_compatilibity(GgsFdebEdge &edge1_, GgsFdebEdge &edge2_);
     ...
     */
    static double scale_compatibility(GgsFdebEdge &edge1_, GgsFdebEdge &edge2_);
     ...
     */
    static double position_compatibility(GgsFdebEdge &edge1_, GgsFdebEdge &edge2_);
     ...
     * @return       Visibility.
     */
    static double edge_visibility(GgsFdebEdge &edge1_, GgsFdebEdge &edge2_);
     ...
     */
    static double visibility_compability(GgsFdebEdge &edge1_, GgsFdebEdge &edge2_);
};
