/********************************************************************************
** Form generated from reading UI file 'GgsMingleWidget.ui'
**
...
#ifndef UI_GGSMINGLEWIDGET_H
#define UI_GGSMINGLEWIDGET_H
...
public:
    ...
    void setupUi(QWidget *GgsMingleWidget)
    {
        if (GgsMingleWidget->objectName().isEmpty())
            GgsMingleWidget->setObjectName(QString::fromUtf8("GgsMingleWidget"));
        GgsMingleWidget->resize(493, 680);
        gridLayout = new QGridLayout(GgsMingleWidget);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(3, 3, 3, 3);
        scrollArea = new QScrollArea(GgsMingleWidget);
        ...
        retranslateUi(GgsMingleWidget);

        QMetaObject::connectSlotsByName(GgsMingleWidget);
    } // setupUi

    void retranslateUi(QWidget *GgsMingleWidget)
    {
        GgsMingleWidget->setWindowTitle(QApplication::translate("GgsMingleWidget", "MINGLE", nullptr));
        groupBoxGraph->setTitle(QApplication::translate("GgsMingleWidget", "\345\233\276\345\261\202", nullptr));
        labelGraph->setText(QApplication::translate("GgsMingleWidget", "\351\200\211\346\213\251\345\233\276\345\233\276\345\261\202", nullptr));
        groupBoxAlgoParams->setTitle(QApplication::translate("GgsMingleWidget", "\347\256\227\346\263\225\345\217\202\346\225\260", nullptr));
        labelCurvenessAngle->setText(QApplication::translate("GgsMingleWidget", "Angle", nullptr));
        labelNeighbors->setText(QApplication::translate("GgsMingleWidget", "Neighbors", nullptr));
        groupBoxRenderParams->setTitle(QApplication::translate("GgsMingleWidget", "\346\270\262\346\237\223\345\217\202\346\225\260", nullptr));
        labelDelta->setText(QApplication::translate("GgsMingleWidget", "Delta(100%)", nullptr));
        labelCurveness->setText(QApplication::translate("GgsMingleWidget", "Curveness(100%)", nullptr));
        checkBoxLoose->setText(QApplication::translate("GgsMingleWidget", "\345\220\257\347\224\250\346\235\276\345\274\233", nullptr));
        labelMargin->setText(QApplication::translate("GgsMingleWidget", "Margin", nullptr));
        labelLineType->setText(QApplication::translate("GgsMingleWidget", "Line Type", nullptr));
        labelLineType_2->setText(QApplication::translate("GgsMingleWidget", "Color", nullptr));
        labelAlpha->setText(QApplication::translate("GgsMingleWidget", "Alpha(100%)", nullptr));
        pushButtonRun->setText(QApplication::translate("GgsMingleWidget", "\350\277\220\350\241\214", nullptr));
    } // retranslateUi

};

namespace Ui {
    class GgsMingleWidget: public Ui_GgsMingleWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_GGSMINGLEWIDGET_H
